...
public class ClockGUI extends Applet implements KeyListener, ClockTimeDisplay, ItemListener {
	...
	public void init() {
		...
		sharedData = new SharedData(clkoutput, clkinput);
		control = new AlarmClock(clkinput, clkoutput, sharedData);
		counter = new ClockCounter(sharedData, clkinput);
	}
